...
ActiveRecord::Schema.define(version: 20160907121436) do
  ...
  create_table "faculty_affiliations", force: :cascade do |t|
    ...
    t.date     "join_from",    default: '2016-09-09'
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
  end
  ...
  create_table "user_curriculars", force: :cascade do |t|
    ...
    t.date     "date",            default: '2016-09-09'
    t.string   "file",            default: ""
    t.string   "text_field",      default: "",           null: false
    t.string   "file_type",       default: "",           null: false
    t.boolean  "active",          default: false
  ...
  create_table "user_experiences", force: :cascade do |t|
    ...
    t.date     "start_from",      default: '2016-09-09'
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "date_of_birth",                                 default: "2016-09-09"
    ...
    t.string   "faculty_join_from",                             default: "2016-09-09"
