...
ActiveRecord::Schema.define(version: 20160829052358) do
  ...
  create_table "user_curriculars", force: :cascade do |t|
    ...
    t.date     "date",            default: '2016-08-29'
    t.string   "file",            default: ""
    t.string   "file_type",       default: "",           null: false
    t.boolean  "active",          default: false
    t.datetime "created_at",                             null: false
  ...
  create_table "user_experiences", force: :cascade do |t|
    ...
    t.date     "start_from",      default: '2016-08-29'
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "date_of_birth",                                 default: "2016-08-29"
    ...
    t.string   "faculty_join_from",                             default: "2016-08-29"
