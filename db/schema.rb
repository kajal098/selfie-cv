...
ActiveRecord::Schema.define(version: 20161213072810) do
  ...
  create_table "company_stocks", force: :cascade do |t|
    ...
    t.string   "time_zone",        default: "2016-12-21 05:04:20.123411"
    t.datetime "created_at",                                              null: false
    t.datetime "updated_at",                                              null: false
  end
  ...
  create_table "faculty_affiliations", force: :cascade do |t|
    ...
    t.date     "join_from",    default: '2016-12-21'
    t.date     "join_till",    default: '2016-12-21'
    t.string   "file",         default: ""
    t.string   "file_type",    default: "",           null: false
    t.string   "file_status",  default: "true",       null: false
    t.datetime "created_at",                          null: false
  ...
  create_table "stock_countries", force: :cascade do |t|
    t.string   "name",        default: "",                    null: false
    t.string   "date_format", default: "dd/mm/yyyy",          null: false
    t.datetime "start_time",  default: '2016-12-21 05:04:19'
    t.datetime "end_time",    default: '2016-12-21 05:04:19'
    t.datetime "created_at",                                  null: false
    t.datetime "updated_at",                                  null: false
  end
  ...
  create_table "user_curriculars", force: :cascade do |t|
    ...
    t.date     "date",            default: '2016-12-21'
    t.string   "file",            default: ""
    t.string   "file_type",       default: "",           null: false
    t.string   "file_status",     default: "true",       null: false
    t.boolean  "active",          default: false
  ...
  create_table "user_experiences", force: :cascade do |t|
    ...
    t.date     "start_from",      default: '2016-12-21'
    t.date     "working_till",    default: '2016-12-21'
    t.string   "designation",     default: "",           null: false
    t.string   "description",     default: "",           null: false
    t.string   "file",            default: ""
    t.string   "file_type",       default: "",           null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "faculty_join_from",                             default: "2016-12-21"
