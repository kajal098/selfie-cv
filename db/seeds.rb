...
CompanyStock.create(stock_country_id: "1",	sensex: "ABC", currency: "A$", category_id:1)
CompanyStock.create(stock_country_id: "1",	sensex: "XYZ", currency: "A$", category_id:2)
CompanyStock.create(stock_country_id: "1",	sensex: "PQR", currency: "A$", category_id:3)

CompanyStock.create(stock_country_id: "2",	sensex: "ABC", currency: "€", category_id:1)
CompanyStock.create(stock_country_id: "2",	sensex: "XYZ", currency: "€", category_id:2)
CompanyStock.create(stock_country_id: "2",	sensex: "PQR", currency: "€", category_id:3)

CompanyStock.create(stock_country_id: "3",	sensex: "ABC", currency: "R$", date_format: "dd/mm/yyyy", category_id:1)
CompanyStock.create(stock_country_id: "3",	sensex: "XYZ", currency: "R$", date_format: "dd/mm/yyyy", category_id:2)
CompanyStock.create(stock_country_id: "3",	sensex: "PQR", currency: "R$", date_format: "dd/mm/yyyy", category_id:3)

CompanyStock.create(stock_country_id: "4",	sensex: "ABC", currency: "CA$", date_format: "DD/MM/YYYY", category_id:1)
CompanyStock.create(stock_country_id: "4",	sensex: "XYZ", currency: "CA$", date_format: "DD/MM/YYYY", category_id:2)
CompanyStock.create(stock_country_id: "4",	sensex: "PQR", currency: "CA$", date_format: "DD/MM/YYYY", category_id:3)

CompanyStock.create(stock_country_id: "5",	sensex: "ABC", currency: "CHF", date_format: "dd.mm.yyyy", category_id:1)
CompanyStock.create(stock_country_id: "5",	sensex: "XYZ", currency: "CHF", date_format: "dd.mm.yyyy", category_id:2)
CompanyStock.create(stock_country_id: "5",	sensex: "PQR", currency: "CHF", date_format: "dd.mm.yyyy", category_id:3)
