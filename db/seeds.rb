...
UserPercentage.create(ptype: 'setting', key: 'site_name', value: 'http://selfie-cv-development.herokuapp.com/')
UserPercentage.create(ptype: 'setting', key: 'site_email', value: 'selfiecv2016@gmail.com')
UserPercentage.create(ptype: 'setting', key: 'site_phone', value: '9988776655')
UserPercentage.create(ptype: 'setting', key: 'site_fax', value: '123456789')
UserPercentage.create(ptype: 'setting', key: 'facebook_url', value: 'https://www.facebook.com/selfiecv')
UserPercentage.create(ptype: 'setting', key: 'twitter_url', value: 'https://www.twitter.com/selfiecv')
UserPercentage.create(ptype: 'setting', key: 'google_plus_url', value: 'https://www.googleplus.com/selfiecv')
