...
CompanyStock.create(country: "Argentina",	sensex: "BCBA", currency: "ARS")
CompanyStock.create(country: "Austria",		sensex: "VIE", currency: "€")
CompanyStock.create(country: "Australia",	sensex: "ASX", currency: "A$")
CompanyStock.create(country: "Belgium",		sensex: "EBR", currency: "€")
CompanyStock.create(country: "Brazil",		sensex: "BVMF", currency: "R$")
CompanyStock.create(country: "Canada",		sensex: "CNSX", currency: "CA$")
CompanyStock.create(country: "Switzerland",	sensex: "SWX", currency: "CHF")
CompanyStock.create(country: "China",		sensex: "SHA", currency: "CN¥")
CompanyStock.create(country: "Denmark",		sensex: "CPH", currency: "DKK")
CompanyStock.create(country: "Estonia",		sensex: "TAL", currency: "€")
CompanyStock.create(country: "Finland",		sensex: "HEL", currency: "€")
CompanyStock.create(country: "France",		sensex: "EPA", currency: "€")
CompanyStock.create(country: "Germany",		sensex: "FRA", currency: "€")
CompanyStock.create(country: "Spain",		sensex: "BME", currency: "€")
CompanyStock.create(country: "Hong Kong",	sensex: "HKG", currency: "HK$")
CompanyStock.create(country: "Israel",		sensex: "TLV", currency: "₪")
CompanyStock.create(country: "India",		sensex: "BOM", currency: "Rs.")
CompanyStock.create(country: "Iceland",		sensex: "ICE", currency: "ISK")
CompanyStock.create(country: "Italy",		sensex: "BIT", currency: "€")
CompanyStock.create(country: "Japan",		sensex: "TYO", currency: "¥")
CompanyStock.create(country: "Korea",		sensex: "KRX", currency: "₩")
CompanyStock.create(country: "Lithuania",	sensex: "VSE", currency: "€")
CompanyStock.create(country: "Latvia",		sensex: "RSE", currency: "€")
CompanyStock.create(country: "Netherlands",	sensex: "AMS", currency: "€")
CompanyStock.create(country: "New Zealand",	sensex: "NZE", currency: "NZ$")
CompanyStock.create(country: "Poland",		sensex: "WSE", currency: "PLN")
CompanyStock.create(country: "Portugal",	sensex: "ELI", currency: "€")
CompanyStock.create(country: "Russia",		sensex: "MCX", currency: "RUB")
CompanyStock.create(country: "Saudi Arabia",sensex: "TADAWUL", currency: "SAR")
CompanyStock.create(country: "Singapore",	sensex: "SGX", currency: "SGD")
CompanyStock.create(country: "South Africa",sensex: "JSE", currency: "ZAR")
CompanyStock.create(country: "Sweden",		sensex: "STO", currency: "SEK")
CompanyStock.create(country: "Thailand",	sensex: "BKK", currency: "THB")
CompanyStock.create(country: "Turkey",		sensex: "IST", currency: "TRY")
CompanyStock.create(country: "Taiwan",		sensex: "TPE", currency: "NT$")
CompanyStock.create(country: "United Kingdom",sensex: "LON", currency: "£")
CompanyStock.create(country: "United States",sensex: "NASDAQ", currency: "$")
