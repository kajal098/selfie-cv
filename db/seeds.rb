...
Whizquiz.create(question: 'Grand Central Terminal, Park Avenue, New York is the worlds', answer: 'largest railway station')
Whizquiz.create(question: 'Entomology is the science that studies', answer: 'Insects')
...
Whizquiz.create(question: 'Which of the following is a non metal that remains liquid at room temperature?', answer: 'Bromine')
Whizquiz.create(question: 'Chlorophyll is a naturally occurring chelate compound in which central metal is', answer: 'magnesium')
Whizquiz.create(question: 'The name of the Laccadive, Minicoy and Amindivi islands was changed to Lakshadweep by an Act of Parliament in', answer: '1973')
Whizquiz.create(question: 'The members of the Rajya Sabha are elected by', answer: 'elected members of the legislative assembly')
...
Whizquiz.create(question: 'The Homolographic projection has the correct representation of', answer: 'area')
