...
CompanyStock.create(sensex_co: "Australia",	sensex: "ABC", currency: "A$", category_id:1)
CompanyStock.create(sensex_co: "Australia",	sensex: "XYZ", currency: "A$", category_id:2)
CompanyStock.create(sensex_co: "Australia",	sensex: "PQR", currency: "A$", category_id:3)

CompanyStock.create(sensex_co: "Belgium",		sensex: "ABC", currency: "€", category_id:1)
CompanyStock.create(sensex_co: "Belgium",		sensex: "XYZ", currency: "€", category_id:2)
CompanyStock.create(sensex_co: "Belgium",		sensex: "PQR", currency: "€", category_id:3)

CompanyStock.create(sensex_co: "Brazil",		sensex: "ABC", currency: "R$", date_format: "dd/mm/yyyy", category_id:1)
CompanyStock.create(sensex_co: "Brazil",		sensex: "XYZ", currency: "R$", date_format: "dd/mm/yyyy", category_id:2)
CompanyStock.create(sensex_co: "Brazil",		sensex: "PQR", currency: "R$", date_format: "dd/mm/yyyy", category_id:3)

CompanyStock.create(sensex_co: "Canada",		sensex: "ABC", currency: "CA$", date_format: "DD/MM/YYYY", category_id:1)
CompanyStock.create(sensex_co: "Canada",		sensex: "XYZ", currency: "CA$", date_format: "DD/MM/YYYY", category_id:2)
CompanyStock.create(sensex_co: "Canada",		sensex: "PQR", currency: "CA$", date_format: "DD/MM/YYYY", category_id:3)

CompanyStock.create(sensex_co: "Switzerland",	sensex: "ABC", currency: "CHF", date_format: "dd.mm.yyyy", category_id:1)
CompanyStock.create(sensex_co: "Switzerland",	sensex: "XYZ", currency: "CHF", date_format: "dd.mm.yyyy", category_id:2)
CompanyStock.create(sensex_co: "Switzerland",	sensex: "PQR", currency: "CHF", date_format: "dd.mm.yyyy", category_id:3)
