...
if @user_stuff
	...
	if @user_stuff.role == 'Jobseeker'
		...
		json.User @user_stuff, :id, :username, :email, :role, :title, :first_name, :middle_name, :last_name, :gender, :date_of_birth, :nationality, :address, :city, :zipcode, :contact_number, :file_type, :text_field, :active
		...
		json.User @user_stuff, :id, :username, :email, :role, :first_name, :last_name, :middle_name, :gender, :date_of_birth, :nationality, :address, :city, :zipcode, :contact_number, :file_type, :text_field, :active
		json.profile_thumb @user_stuff.profile_thumb_url
		json.profile @user_stuff.profile_pic.url
		...
		json.User @user_stuff, :id, :username, :email, :role, :first_name, :middle_name, :last_name, :gender, :date_of_birth, :nationality, :address, :city, :zipcode, :contact_number, :faculty_work_with_type, :faculty_uni_name, :faculty_subject, :faculty_designation, :faculty_join_from, :file_type, :text_field, :active
		json.profile_thumb @user_stuff.profile_thumb_url
		json.profile @user_stuff.profile_pic.url
		json.resume_thumb @user_stuff.resume_thumb_url
		json.resume @user_stuff.file.url
