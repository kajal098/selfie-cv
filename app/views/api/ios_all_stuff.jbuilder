...
if @user_stuff
	if @user_stuff.role == 'Jobseeker'
		...
		json.user_resume_per @user_stuff.user_meter ? @user_stuff.user_meter.resume_per.to_i : 0
		json.user_achievement_per @user_stuff.user_meter ? @user_stuff.user_meter.achievement_per.to_i : 0
		json.user_curricular_per @user_stuff.user_meter ? @user_stuff.user_meter.curri_per.to_i : 0
		json.user_future_goal_per @user_stuff.user_meter ? @user_stuff.user_meter.future_goal_per.to_i : 0
		json.user_working_environment_per @user_stuff.user_meter ? @user_stuff.user_meter.working_env_per.to_i : 0
		json.user_reference_per @user_stuff.user_meter ? @user_stuff.user_meter.ref_per.to_i : 0
		json.user_whizquiz_per @user_stuff.user_meter ? @user_stuff.user_meter.whizquiz_per.to_i : 0
...
json.company_info_per @user_stuff.user_meter ? @user_stuff.user_meter.company_info_per.to_i : 0
json.company_corporate_identity_per @user_stuff.user_meter ? @user_stuff.user_meter.corporate_identity_per.to_i : 0
json.company_growth_and_goal_per @user_stuff.user_meter ? @user_stuff.user_meter.growth_and_goal_per.to_i : 0
json.achievement_per @user_stuff.user_meter ? @user_stuff.user_meter.achievement_per.to_i : 0
json.company_gallery_per @user_stuff.user_meter ? @user_stuff.user_meter.galery_per.to_i : 0
json.company_working_env_per @user_stuff.user_meter ? @user_stuff.user_meter.working_env_per.to_i : 0
json.total_per @user_stuff.user_meter ? @user_stuff.user_meter.profile_meter_per.to_i : 0
...
json.student_basic_info_per @user_stuff.user_meter ? @user_stuff.user_meter.student_basic_info_per.to_i : 0
...
json.total_per @user_stuff.user_meter ? @user_stuff.user_meter.profile_meter_per.to_i : 0
		...
		json.faculty_basic_info_per @user_stuff.user_meter ? @user_stuff.user_meter.faculty_basic_info_per.to_i : 0
      	json.experience_per @user_stuff.user_meter ? @user_stuff.user_meter.experience_per.to_i : 0
      	json.achievement_per @user_stuff.user_meter ? @user_stuff.user_meter.achievement_per.to_i : 0
      	json.total_per @user_stuff.user_meter ? @user_stuff.user_meter.profile_meter_per.to_i : 0
